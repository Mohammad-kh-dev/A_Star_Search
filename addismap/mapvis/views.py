...
def mapapp(request):
    if request.method == 'GET':
        ...
        context = {
            'message':message,
            'GMAPS_API_KEY': 'AIzaSyDKTuVDzFB5i4v1QGSKc97PXR02KA3IVkc'
        }

    if request.method == 'POST':

        osmPath = "C:/Users/Mohammad/Downloads/Compressed/AddisMap-master/addismap/mapvis/oak.osm"
...
def addisMapapp(request):
    ...
    if request.method == 'POST':
        ...
        osmPath = "C:/Users/Mohammad/Downloads/Compressed/AddisMap-master/addismap/mapvis/gerjisecond.osm"
        nodes = extract_osm_nodes(osmPath)
        edges = extract_osm_edges(osmPath)
        adj_list = adjacency_list(nodes, edges)
        node = namedtuple('Node', ['lat', 'lng'])
#####
    ...
    return render(request, 'mapvis/addismapapp.html', context)